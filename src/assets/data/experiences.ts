...
export const experiences: IExp[] = [
  {
    ...
    learns: ['Laravel', 'Tailwind', 'Bootstrap', 'MySQL', 'Linux', 'Apache', 'Product planning']
  },
  {
  ...
  },
  {
    ...
    learns: ['Laravel', 'Express', 'PostgresSQL', 'Docker', 'Microservices', 'ERP Dev', 'Figma', 'Socket IO']
  },
  {
    ...
    learns: ['NestJS', 'NextJS', 'ReactJS', 'MongoDB', 'Microservices', 'Rabbitmq', 'Azure devops', 'Websocket', 'Xendit payment']
  },
  {
    title: 'Backend Develoeper',
    company: 'PT Serasi Autoraya ( SERA )',
    date: 'Feb 2024 - Present',
    description: `Create new product TRAC as Backend developer`,
    learns: ['Express JS', 'TypeScript', 'PostgresSQL', 'Microservices', 'AWS S3', 'AWS SQS', 'JIRA', 'Firebase', 'Xendit payment']
  }
]
